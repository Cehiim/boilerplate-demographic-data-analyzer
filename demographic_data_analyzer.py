...
def calculate_demographic_data(print_data=True):
    ...
    # What percentage of the people whol work the minimum number of hours per week have a salary of >50K?
    ...
    rich_countries = rich["native-country"].value_counts()
    total_countries = df["native-country"].value_counts()
    countries_percentage = round(rich_countries / total_countries * 100, 1)

    highest_earning_country = countries_percentage.idxmax()
    highest_earning_country_percentage = countries_percentage.max()
